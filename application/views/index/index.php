                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if (!$tanggalwal && !$tanggakhir) : ?>
                            ...
                            <h4 class="text-center mt-2"> Laporan Income masuk tanggal <?= date('d F Y'); ?> </h4>
                        <?php else : ?>
                            ...
                            <h4 class="text-center mt-2"> Laporan Income masuk tanggal <?= $tanggalwal . ' s/d' . $tanggakhir ?> </h4>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="card mt-2">
